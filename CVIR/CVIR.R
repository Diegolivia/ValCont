#' @title CVIR: Content Validity Index, Revised
#' @description Calculate the CVI coefficient with chance agreement adjustment (Polit & Beck, 2007).
...
#' As with the 'CVI' function, in 'CVIR' items can be rated with a wide range of point scales (Polit, Beck,
#' & Owen, 2007; Polit, & Beck, 2006). This rating scale can be 3-point, or usually 4- or 5-point
#' (Lynn,1986; Waltz & Bausell, 1981). 
#' The 'CVIR' cutoff point, for identifying valid items, is generally based on the last two top ratings; 
#' for example, on a relevance scale of 1 to 4, the cutoff point may be 3 (Beck & Gable, 2001; Grant & 
#' Davis, 1997). 'CVIR' uses 'cut' to dichotomice the judges' responses and transform them into the CVI.
#' The asymmetric confidence intervals use Wilson's (1927) approach, as applied to Aiken's V coefficient
#' (Penfield, & Giacobbi, 2004). The results should be complemented by an estimator of inter-judge
#' variability or agreement.
#' 
#' **Note**: The function has not yet been prepared to resolve missing values, so the user must remove or
...
#' Research, 5, 194–197
#' 
#' Grant, J.S., & Davis, L.T. (1997). Selection and use of content experts in instrument development. 
...
#' 382–385.
#' 
#' Penfield, R. D. & Giacobbi, P. R., Jr. (2004) Applying a score confidence interval to Aiken’s item
#' content-relevance index. Measurement in Physical Education and Exercise Science, 8(4), 213-225.
...
#' Appraisal and recommendations. Res. Nurs. Health, 30: 459-467. https://doi.org/10.1002/nur.20199
#' 
#' Waltz, C.F., & Bausell, R.B. (1981). Nursing research: Design, statistics, and computer analysis. 
#' Philadelphia: F. A. Davis.
#' 
#' Wilson, E. B. (1927). Probable inference, the law of succession, and statistical inference. 
#' Journal of the American Statistical Association, 22, 209-212. doi: 10.2307/2276774
#' 
#' @seealso
...
#' 
#' Run
#' CVIR(data = Ej, cut = 4, conf.level = .90)

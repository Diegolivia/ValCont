#' @title CIDsingle (Confidence interval for difference: single item)
...
#' judgments tend to be asymmetrically distributed (if the item is rated, on a scale of 1 to 5, as predominantly valid then its values will be > 3), MOVER is appropriate for non-normal distributions.
...
#' There is \code{\link{ValCont::CID}} for this method for multiple items, however'CID_single' function compares the
...
#' 
#' @seealso
#' \code{\link{ratesci::mover}} for MOVER method ofr ratios
#' \code{\link{PropCIs::scoreci}} for score method confidence interval
#' \code{\link{ValCont::CID}} for this method for multiple items
#' 
#' @examples
#' 
#' ### Example
